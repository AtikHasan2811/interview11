...
Route::get('/menue','newMenuController@index');

Auth::routes();
Route::group(['middleware'=>'auth'],function(){
    Route::get('/new_menu','HomeController@newMenu');
    Route::post('/fetch_data','HomeController@fetchData');
});
...
Route::get('/settings', 'PagesController@settings')->name('menue');


Route::get('/menu', 'PagesController@index')->name('index');
